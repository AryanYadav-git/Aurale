  ...
  return (
    <div className="w-full">
      <div className="flex flex-col h-full w-full ">
        ...
        <div className="z-10 ">
          {artist && <div className="lg:h-72 flex flex-col justify-end p-6 gap-2">
            {artist.verified ? (<p className="font-semibold text-sm lg:text-base flex gap-2">
              <IconRosetteDiscountCheckFilled className="text-blue-500 size-4 lg:size-fit"/> Verified Artist
              </p>): <span></span>}
            <h1 className="text-6xl lg:text-8xl font-black font-sans uppercase">{artist.stageName}</h1>
